 ...
 * @{
 */
#define I2C_CLOCK_CONTROL__CLK_PU__SHIFT                                     10
#define I2C_CLOCK_CONTROL__CLK_PU__WIDTH                                      1
#define I2C_CLOCK_CONTROL__CLK_PU__MASK                             0x00000400U
...
#define I2C_CLOCK_CONTROL__CLK_PU__RESET_VALUE                      0x00000000U
/** @} */
#define I2C_CLOCK_CONTROL__TYPE                                        uint32_t
#define I2C_CLOCK_CONTROL__READ                                     0x000007ffU
#define I2C_CLOCK_CONTROL__WRITE                                    0x000007ffU
#define I2C_CLOCK_CONTROL__PRESERVED                                0x00000000U
#define I2C_CLOCK_CONTROL__RESET_VALUE                              0x00000007U
...
#define I2C_OUTGOING_DATA__DATA_PU__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00010000U) | ((uint32_t)(0) << 16)
#define I2C_OUTGOING_DATA__DATA_PU__RESET_VALUE                     0x00000000U
/** @} */
...
#define I2C_OUTGOING_DATA__RESET_VALUE                              0x0000ff00U
...
#define I2C_TRANSACTION_STATUS__READ                                0x00000007U
...
#define I2C_INTERRUPT_MASK__READ                                    0x00000007U
#define I2C_INTERRUPT_MASK__WRITE                                   0x00000007U
...
#define I2C_INTERRUPT_STATUS__READ                                  0x00000007U
 ...
 * @details set interrupt1; not auto cleared
 * @{
 */
 ...
 * @details set interrupt2; not auto cleared
 * @{
 */
...
#define I2C_SET_INTERRUPT__READ                                     0x00000007U
#define I2C_SET_INTERRUPT__WRITE                                    0x00000007U
 ...
 * @details clear interrupt1; not auto cleared
 * @{
 */
 ...
 * @details clear interrupt2; not auto cleared
 * @{
 */
...
#define I2C_RESET_INTERRUPT__READ                                   0x00000007U
#define I2C_RESET_INTERRUPT__WRITE                                  0x00000007U

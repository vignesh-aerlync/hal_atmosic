 ...
 * @details clears fifo_overflow_intrpt; not auto cleared.
 * @{
 */
 ...
 * @details clears lwm_hit_intrpt; not auto cleared.
 * @{
 */
 ...
 * @details clears fifo_sel_error_intrpt; not auto cleared.
 * @{
 */
 ...
 * @details clears fifo_cmd_done_intrpt; not auto cleared.
 * @{
 */
 ...
 * @details sets fifo_overflow_intrpt; not auto cleared.
 * @{
 */
 ...
 * @details sets lwm_hit_intrpt; not auto cleared.
 * @{
 */
 ...
 * @details sets fifo_sel_error_intrpt; not auto cleared.
 * @{
 */
 ...
 * @details sets fifo_cmd_done_intrpt; not auto cleared.
 * @{
 */

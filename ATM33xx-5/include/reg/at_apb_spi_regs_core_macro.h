...
#define SPI_CTRL__READ                                              0x800fffffU
#define SPI_CTRL__WRITE                                             0x800fffffU
 ...
 * @details Master data; don't add 1 for opcode
 * @{
 */
 ...
 * @details invert mosi; keep static during entire spi transaction
 * @{
 */
 ...
 * @details introduce a delay between spi_csn falling and first bit on mosi
 * @{
 */
 ...
 * @brief transaction setup by DMA definitions.
 * @{
 */
 ...
 * @details set interrupt3; not auto cleared
 * @{
 */
 ...
 * @details clear interrupt3; not auto cleared
 * @{
 */

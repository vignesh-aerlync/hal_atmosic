 ...
 * @details write 1 to clear the write pointer. Not Self-clearing.
 * @{
 */
 ...
 * @details Write 1 to start the SHA256 or HMAC operation.  CPU should configure relative information first, such as message_length, secret_key.
 * @{
 */
 ...
 * @details Write 1 to process the final SHA256 digest or calculate the HMAC message hash.
 * @{
 */
...
#define AT_SHA2_CMD__READ                                           0x00000003U
#define AT_SHA2_CMD__WRITE                                          0x00000003U
...
#define AT_SHA2_STATUS__READ                                        0x000001ffU
 ...
 * @details if nth bit set, the nth interrupt is set;
 * @{
 */
 ...
 * @details if nth bit set, the nth interrupt is reset;
 * @{
 */

 ...
 * @details Top LDO bypass override, MSB enables override, LSB is the override value
 * @{
 */
 ...
 * @details Top-level ATB mux select, 0 = high-Z, 1 = bias, 2 = synth/TX, 3 = RX, 4 = LDO, 5 = PLL, 6 = WuRX, 7 = reserved
 * @{
 */
...
#define RADIO_TOP_VERSION__REV_ID__RESET_VALUE                      0x00000021U
/** @} */
...
#define RADIO_TOP_VERSION__PROD_ID__READ(src) \
                    (((uint32_t)(src)\
                    & 0x0000ff00U) >> 8)
#define RADIO_TOP_VERSION__PROD_ID__RESET_VALUE                     0x00000002U
/** @} */
...
#define RADIO_TOP_VERSION__RESET_VALUE                              0x00000221U
